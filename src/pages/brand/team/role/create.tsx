...
export default function OwnerRoleFormPage() {
    ...
    // Get permission groups for brand tenant type
    const groups = getPermissionGroupsByTenantType('brand');
    ...
    if (isEditMode && !role && !isLoadingRole) {
        return (
            <div className="flex flex-col items-center justify-center h-[calc(100vh-4rem)] space-y-4">
                ...
                <Button onClick={() => navigate('/brand/team/role')}>Back to Roles</Button>
            </div>
        );
    }
        ...
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    <Button variant="outline" onClick={() => navigate('/brand/team/role')}>
                        Cancel
                    </Button>
